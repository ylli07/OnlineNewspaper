...
export default function World() {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/api/news?category=world')
      .then(res => res.json())
  ...
  return (
    <div style={styles.container}>
      ...
      <h1 style={styles.title}>World News</h1>
      <div style={styles.imageContainer}>
        <div style={styles.topImageBox}>
          <img src="/path/to/image1.jpg" alt="World Image 1" style={styles.topImage} />
          <div style={styles.imageCaption}>Përshkrimi i fotos 1</div>
        </div>
        <div style={styles.topImageBox}>
          <img src="/path/to/image2.jpg" alt="World Image 2" style={styles.topImage} />
